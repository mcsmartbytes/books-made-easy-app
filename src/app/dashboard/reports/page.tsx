...
const reports: Report[] = [
  ...
  // Job Costing
  { id: 'wip', name: 'Work In Progress (WIP)', description: 'Revenue recognition, overbilling/underbilling, and backlog', category: 'Job Costing', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
  { id: 'cost-code-variance', name: 'Cost Code Variance', description: 'Budget vs actual by CSI cost code with trend analysis', category: 'Job Costing', icon: 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z' },
  { id: 'margin-forecast', name: 'Margin Forecast', description: 'Projected margins, cost-to-complete, and margin erosion across all jobs', category: 'Job Costing', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
  { id: 'retainage', name: 'Retainage Aging', description: 'Retainage receivable and payable aging with release tracking', category: 'Job Costing', icon: 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z' },
  { id: 'cash-flow-forecast', name: 'Cash Flow Forecast', description: 'Projected cash inflows, outflows, and position by week across all jobs', category: 'Job Costing', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
  // Multi-Entity
  { id: 'consolidated', name: 'Consolidated Report', description: 'Cross-entity P&L comparison with intercompany eliminations', category: 'Multi-Entity', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
  // Receivables
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Link href="/dashboard/reports/custom" className="btn-primary">
